...
# 1. SET UP ĐƯỜNG DẪN GIỐNG HỆT FILE CŨ CỦA ÔNG
...
class ZeroCacheCLIPVision:
    ...
    def encode(self, clip_name, image, device):
        ...
        # [QUAN TRỌNG] Lưu Tensor ảnh thành file để truyền qua Subprocess
        ...
        print(f"\n[👁️] Active Zero-Cache Vision Worker: [{clip_name}] | Device: [{device.upper()}]")
        
        # Gọi luồng phụ y chang code cũ
...
# 4. KHỐI THỰC THI LUỒNG PHỤ (GIỮ NGUYÊN LOGIC BẮT CỜ CỦA ÔNG)
