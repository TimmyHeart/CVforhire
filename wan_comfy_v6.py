...
║  CMP 40HX (Turing SM7.5) · PCIe 1.1 x16 · RAM 16GB · VRAM 8GB            ║
╠══════════════════════════════════════════════════════════════════════════════╣
...
COMFY_MODEL_HIGH = r"F:\simulator\AI\Local\models\wan22High.safetensors"
COMFY_MODEL_LOW  = r"F:\simulator\AI\Local\models\wan22Low.safetensors"
...
CLIP_ENCODER_DIR = r"F:\simulator\AI\Local\CLIP_ENCODER" 
...
def load_and_remap_lora(pipe, lora_path, adapter_name):
    ...
    remapped_name = f"{name_without_ext}_remapped{ext}"
...
def load_transformer_smart(converted_dir):    
    # Load model vào CPU (nếu RAM vật lý thiếu, Windows sẽ tự nhét vào Pagefile)
